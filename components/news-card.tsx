...
export default function NewsCard({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-xl transition-all duration-300 hover:shadow-lg cursor-pointer transform hover:scale-[1.02]",
        className,
      )}
    ...
    >
      <div className="relative aspect-video w-full overflow-hidden rounded-xl">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
          <h3 className={cn("font-bold line-clamp-2 mb-2", isFeatureCard ? "text-2xl" : "text-lg")}>{article.title}</h3>
